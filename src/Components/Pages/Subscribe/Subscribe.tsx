  ...
  return (
    <div className='w-full flex flex-col items-center gap-28 '>
        ...
        <div className='tinn flex flex-col items-center gap-10   '>
          ...
          <button className='btn text-xl hover:bg-teal-300' onClick={()=> setCheckout(true)} >Create your plan</button>
        </div>
        ...
        <div className={checkout? 'os-container rounded-lg  flex flex-col gap-7   items-center' : "hidden"}>
          ...
          <button id="btn" className='btn text-white w-72 md:text-lg md:ml-44 hover:bg-teal-300 'onClick={()=> setCheckout(false)} >Checkout <span className='spazz md:absolute  md:text-3xl md:font-bold md:text-black '>$14.00 / mo</span></button>
          </div>
        </div>
